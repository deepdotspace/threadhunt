 ...
 */
const TOAST_CONFIG = {
  success: { Icon: CheckCircleIcon, accent: 'bg-[var(--accent)]', icon: 'text-[var(--accent)]' },
  error:   { Icon: AlertCircleIcon, accent: 'bg-[var(--status-edited-text)]', icon: 'text-[var(--status-edited-text)]' },
  warning: { Icon: AlertTriangleIcon, accent: 'bg-[var(--status-edited-text)]', icon: 'text-[var(--status-edited-text)]' },
  info:    { Icon: InfoIcon, accent: 'bg-[var(--text-3)]', icon: 'text-[var(--text-2)]' },
} as const
  ...
  return (
    <div
      className={`
        ...
        overflow-hidden rounded-[var(--radius)] border border-[var(--border-2)]
        bg-[var(--bg-3)] text-[var(--text-1)] pl-3.5 pr-2 py-2.5
        shadow-[var(--shadow)]
        ${exiting
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        {toast.description && (
          <p className="mt-0.5 text-xs leading-snug text-[var(--text-3)]">
            {toast.description}
          </p>
        )}
      </div>
      <button
        ...
        className="-mr-0.5 shrink-0 rounded p-1 text-[var(--text-3)] transition-colors hover:bg-[var(--bg-1)] hover:text-[var(--text-1)]"
        aria-label="Dismiss"
      >
